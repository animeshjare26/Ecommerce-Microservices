...
### 🗄️ Module 3: Database & Persistence
1. [Database Indexing Internals: B-Trees, Composite Indexes, and EXPLAIN ANALYZE](03-database-and-persistence/01_INDEXING_INTERNALS_B_TREES_AND_EXPLAIN_ANALYZE.md)
...
2. [Transactions, ACID Properties, Isolation Levels, and PostgreSQL MVCC](03-database-and-persistence/02_TRANSACTIONS_ACID_AND_ISOLATION_LEVELS.md)
...
3. [JPA Entity Lifecycle, The First-Level Cache, and Automatic Dirty Checking](03-database-and-persistence/03_JPA_ENTITY_LIFECYCLE_FIRST_LEVEL_CACHE_DIRTY_CHECKING.md)
...
4. [The N+1 Query Problem, Fetch Types, and High-Performance JPA Queries](03-database-and-persistence/04_N_PLUS_ONE_PROBLEM_FETCH_TYPES_AND_EFFICIENT_QUERIES.md)
...
5. [Concurrency Control: Optimistic vs. Pessimistic Locking and Inventory](03-database-and-persistence/05_CONCURRENCY_CONTROL_OPTIMISTIC_VS_PESSIMISTIC_LOCKING.md)
...
6. [Database Migrations with Flyway and Zero-Downtime Schema Evolution](03-database-and-persistence/06_DATABASE_MIGRATIONS_WITH_FLYWAY_AND_ZERO_DOWNTIME_SCHEMA_EVOLUTION.md)
...
### 🧯 Module 6: API Design & Resilience
1. [Idempotency Keys and Preventing Duplicate Payments](06-api-design-and-resilience/01_IDEMPOTENCY_KEYS_AND_PAYMENT_DEDUPLICATION.md)
...
2. [Timeouts, Retries, Exponential Backoff, and Jitter](06-api-design-and-resilience/02_TIMEOUTS_RETRIES_EXPONENTIAL_BACKOFF_AND_JITTER.md)
...
3. [Circuit Breakers, Bulkheads, and Graceful Degradation](06-api-design-and-resilience/03_CIRCUIT_BREAKER_AND_BULKHEAD_WITH_RESILIENCE4J.md)
...
4. [RESTful API Design, RFC 7807 Problem Details, and Keyset Pagination](06-api-design-and-resilience/04_RESTFUL_API_DESIGN_ERROR_HANDLING_RFC7807_PAGINATION.md)
