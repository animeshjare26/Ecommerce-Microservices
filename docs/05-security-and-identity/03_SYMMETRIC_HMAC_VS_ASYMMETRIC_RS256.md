...
> **Status:** Implemented
>
> **Related code:** `user-service/src/main/java/com/ecommerce/user/security/jwt/JwtUtils.java`, `user-service/src/main/java/com/ecommerce/user/security/jwt/RsaKeyProvider.java`
>
